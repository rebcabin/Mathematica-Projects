...
NotebookDataLength[    388542,       8495]
NotebookOptionsPosition[    378229,       8171]
NotebookOutlinePosition[    378930,       8196]
CellTagsIndexPosition[    378887,       8193]
WindowFrame->Normal*)
...
Cell[CellGroupData[{
Cell["Counting Calories with Symbolic Computing", "Title",
...
\>", "Subtitle",
 CellChangeTimes->{{3.54334808141787*^9, 3.543348093338062*^9}, {
  3.5535435790719748`*^9, 3.5535435802143908`*^9}}],
...
Jacquard\[CloseCurlyQuote]s ",
 ...
 StyleBox["reuse",
  FontSlant->"Italic"],
 " than the equivalent computation written in ordinary JavaScript. Wfe \
motivate ",
 ButtonBox["Wolfram Research\[CloseCurlyQuote]s Mathematica",
  BaseStyle->"Hyperlink",
  ButtonData->{
...
information in a ",
 ButtonBox["Nutrition Facts Label",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://en.wikipedia.org/wiki/Nutrition_facts_label"], None},
  ButtonNote->"http://en.wikipedia.org/wiki/Nutrition_facts_label"],
 ". Such units conversions are not possible in JavaScript without symbolic \
computing essentially equivalent to Jacquard\[CloseCurlyQuote]s and ",
...
1:
  "]],

Cell[TextData[{
 "We point out that, historically, symbolic computing has been an essential, \
if invisible, part of mission-critical elements in real-world, \
multi-billion-dollar operating system kernels for tasks such as ",
...
pap.htm"],
 ...
 ". The point is that symbolic computing is an under-appreciated methodology, \
routinely applied \[OpenCurlyDoubleQuote]under the radar\
\[CloseCurlyDoubleQuote] for many decades but certainly ripe for much broader \
use in the cloud mainstream. "
}], "Text",
...
Cell[TextData[{
 "We finally exhibit constructing a ",
 ButtonBox["Nutrition Facts Label",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://www.fda.gov/Food/ResourcesForYou/Consumers/NFLPM/ucm274593.\
htm"], None},
  ButtonNote->
   "http://www.fda.gov/Food/ResourcesForYou/Consumers/NFLPM/ucm274593.htm"],
 " on-the-fly from unit ingredients and a previously unknown recipe. This is \
a sum in a vector space with basis vectors comprising the Nutrition Facts \
Labels of the ingredients. We motivate the need for remote evaluation of \
expressions in this scenario: bringing the computation to the data can be \
much cheaper than bringing the data to the computation."
}], "Text",
 CellChangeTimes->{{3.55354321384093*^9, 3.553543254176166*^9}, {
  3.55354340319669*^9, 3.553543414162272*^9}, {3.55354350965662*^9, 
  3.553543569571107*^9}, {3.553543867047773*^9, 3.553543897887105*^9}, {
  3.55373576759105*^9, 3.553735785565439*^9}, {3.553735916921487*^9, 
  3.553735916922338*^9}, {3.553736635635806*^9, 3.553736681055072*^9}}]
}, Open  ]],
...
Cell[TextData[{
 "Consider the ",
 ButtonBox["following Nutrition Facts Label (NFL)",
  BaseStyle->"Hyperlink",
  ButtonData->{
...
Cell["\<\
Does the calorie total implied by the breakdown match the calorie count given \
in the \[OpenCurlyDoubleQuote]amount per serving?\[CloseCurlyDoubleQuote]\
\>", "Item",
...
"], None},
 ...
 " for more about why the \[OpenCurlyDoubleQuote]with\[CloseCurlyDoubleQuote] \
statement is not acceptable in JavaScript."
}], "Text",
 CellChangeTimes->{{3.543492323213721*^9, 3.543492388811721*^9}, {
  3.543497231768639*^9, 3.5434972423777*^9}, {3.543497422954756*^9, 
  3.543497423945855*^9}, {3.5535442953178873`*^9, 3.5535443023490868`*^9}}]
}, Open  ]]
}, Open  ]],
...
In C#, unbound symbols don\[CloseCurlyQuote]t even compile. \
\>", "Text",
 CellChangeTimes->{{3.5435015192416987`*^9, 3.543501647979699*^9}, {
   ...
   3.553544359083794*^9, 3.5535443599639683`*^9}}],

Cell[TextData[{
 "There is an analogy to lazy evaluation. JavaScript eagerly interprets all \
symbols. Jacquard, and term-rewriting systems in general, only interpret them \
when they\[CloseCurlyQuote]re used. And even then, \.08expressions that don\
\[CloseCurlyQuote]t evaluate to something else just evaluate to themselves. A \
symbol without a binding to a value is NOT an error, it\[CloseCurlyQuote]s \
just the symbol itself as a first-class, atomic value. An expression that \
does not reduce further is an expression in so-called ",
 ...
 CellChangeTimes->{{3.553555348958777*^9, 3.553555464268373*^9}, {
  3.5535555081897907`*^9, 3.5535555631783524`*^9}}],
...
left-hand side, please replace it with the right-hand side, after \
substituting any values found for pattern variables on the left-hand side for \
the corresponding variables in the right-hand side.\[CloseCurlyDoubleQuote] \
The patterns-and-rules sublanguage is similar to regular expressions familiar \
from JavaScript, Python, Perl, and text editors, except that it operates over \
other expressions in the language and not just on strings. It lets the \
programmer write rules that will match whole classes of richly structured \
expressions. It allows parts of a program to rewrite other parts of a \
program. It allows part of the program to be a \
...
Cell[TextData[{
 "A rule with only symbolic constants for patterns is equivalent to a \
JavaScript or JSON property, ",
 StyleBox["i.e.",
  FontSlant->"Italic"],
...
themselves.  "
 ...
 CellChangeTimes->{{3.543347679565689*^9, 3.543347680430775*^9}, {
   ...
   3.553565563971002*^9, 3.553565582970561*^9}}],

Cell["\<\
The fact that we can always represent an object as a list of rules reveals \
the deeper fact that objects are just functions from keys to values, a fact \
that is also obvious from noting that objects are implemented as hash tables \
or red-black trees, other representations for functions from keys to values.\
\>", "Text",
 CellChangeTimes->{{3.543347679565689*^9, 3.543347680430775*^9}, {
   3.543356944646019*^9, 3.5433569524370193`*^9}, {3.5433570695270195`*^9, 
   3.543357171210019*^9}, {3.543500985989243*^9, 3.543501072079851*^9}, {
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.543502136568699*^9, 3.543521047936802*^9, 
  ...
  3.553601956512197*^9, 3.553619267939455*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435023046996984`*^9, 3.543521048015802*^9, 
  ...
  3.553601956578743*^9, 3.553619268000278*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435023982706985`*^9, 3.543521048122802*^9, 
  ...
  3.553601956645319*^9, 3.553619268045602*^9}]
}, Open  ]],
...
our own operators to write things in the opposite order should we need. Let\
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.543503130475074*^9, 3.543521048186802*^9, 
  ...
  3.553601956710733*^9, 3.553619268114592*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435031433471737`*^9, 3.543521048255802*^9, 
  ...
  3.553601956760651*^9, 3.55361926817446*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.543503437341571*^9, 3.5435210484068017`*^9, 
  ...
  3.55360195687716*^9, 3.553619268239542*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435034551103473`*^9, 3.543521048483802*^9, 
  ...
  3.553601956927772*^9, 3.5536192682909927`*^9}]
}, Open  ]],

Cell[TextData[{
 "The main point here is that ",
 StyleBox["the expression for the sum of the weights and the list-of-rules \
data-object expression are independent",
  FontSlant->"Italic"],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.543516272373165*^9, 3.5435210485508018`*^9, 
  ...
  3.5536019569948063`*^9, 3.553619268351265*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435164099079175`*^9, 3.543521048753802*^9, 
  ...
  3.5536019571279097`*^9, 3.553619268439152*^9}]
}, Open  ]],
...
solution, the only way she could have caught this is by manually checking the \
...
that this number 160 is not implied by any other data in the nutrition block. \
There is only one instance of 160 to be found in this sample, and that\
\[CloseCurlyQuote]s from this wildly mistaken computation of adding grams to \
milligrams. It\[CloseCurlyQuote]s a strong hypothesis that the original \
authors of the nutrition block added up the weights and got a wrong number, \
then compounded the error by putting the wrong number in the wrong slot.\
\>", "Text",
 CellChangeTimes->{{3.5435164194298697`*^9, 3.543516479920918*^9}, {
   3.54351655814874*^9, 3.543516579301855*^9}, {3.543518359548609*^9, 
   3.543518442824609*^9}, {3.543526734945015*^9, 3.5435267546070147`*^9}, {
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.543516613975322*^9, 3.5435210489078016`*^9, 
  ...
  3.553601957196013*^9, 3.553619268501275*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435166256684914`*^9, 3.5435210489738016`*^9, 
  ...
  3.5536019572607117`*^9, 3.553619268546134*^9}]
}, Open  ]],
...
Cell[TextData[{
 "Now that the point about canonicalization has been made, we can see that \
our ",
...
that software is a spiritual precursor to Jacquard)\
\>", "Text",
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435181066498623`*^9, 3.543521049246802*^9, 
  ...
  3.553601957566348*^9, 3.553619268748551*^9}]
}, Open  ]],
...
Cell[BoxData[
 ...
 CellChangeTimes->{3.5435166256684914`*^9, 3.5435167215740805`*^9, 
  ...
  3.5536019576111298`*^9, 3.553619268806864*^9}]
}, Open  ]],
...
calories for 4 ounces would be over 600. There is certainly strong incentive \
to fib, here. No one wants to eat a 1-ounce burger patty, so maybe just \
report a reasonable size like 4 ounces. That\[CloseCurlyQuote]s rather \
standard for a serving of meat, no?. But no one will eat a 600-calorie burger \
patty, so let\[CloseCurlyQuote]s just lie about that. \
\>", "Text",
...
Cell[TextData[{
 ...
 StyleBox["could",
  FontSlant->"Italic"],
 " be the result of honest mistakes, and we've certainly seen that they're \
all-too-easy using ordinary programming techniques. But it's perhaps even \
...
Cell["\<\
This time, we have to go down the search-results page to find the answers, \
but we have two that agree. There are about 9 calories per gram of fat, and \
that\[CloseCurlyQuote]s good enough for us to find out whether the original \
...
the grams of fat to calories:"
 ...
 CellChangeTimes->{{3.5435193715992455`*^9, 3.543519391273213*^9}, {
  ...
  3.553596040460918*^9, 3.55359606951462*^9}}],
...
Cell["\<\
Ok, looks like the nutrition label reports the number of calories from fat in \
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.5435197872948112`*^9, 3.543519835701651*^9}, 
   ...
   3.5536019577728243`*^9}, 3.553619269014852*^9}]
}, Open  ]],

Cell[TextData[{
 "Notice we used the operator \[OpenCurlyDoubleQuote]//.\
\[CloseCurlyDoubleQuote], shorthand for ",
...
Cell["\<\
Symbolic computing is a general category of computing. Any program that \
manipulates symbols as opposed to manipulating just numerical data is a \
symbolic program. Symbolic programs are not exotic: you use them every day. \
...
t4; templating programs, schema validators, all do symbolic computing. \
\>", "Text",
...
tools as opposed to applications or solutions. You may use them every day, \
but you probably don't write them every day. One message here is to encourage \
you to use symbolic methods more often in your own programs. Application of \
symbolic computing to robust units of measure is a no-brainer. There are many \
other uses: reducing the size and complexity of ordinary programs via \
pattern-matching and rules processing; reasoning over data; analysis and \
optimization of queries; dynamic scripting; many more.\
\>", "Text",
 CellChangeTimes->{{3.543500103962249*^9, 3.543500275707422*^9}, {
  3.543500388520702*^9, 3.543500498901739*^9}, {3.5435005468783016`*^9, 
  3.543500618834302*^9}, {3.543516830002923*^9, 3.5435169060815296`*^9}, {
  ...
  3.543517801358382*^9, 3.543517841651322*^9}, {3.5435779376838655`*^9, 
  3.5435779465473723`*^9}, {3.553627923091592*^9, 3.553628014371537*^9}, {
  3.553628061571259*^9, 3.553628314556294*^9}}],
...
expressions on exactly the same footing as other data. The tools that you \
have for manipulating data will also manipulate expressions, i.e., programs. \
The fundamental unity of code and data is nothing new, it\[CloseCurlyQuote]s \
just not in the daily vocabulary of the ordinary, workaday programmer who is \
stuck in a world where programs are always compiled in isolated sessions and \
executed in other sessions and environments. The gap between analyzing a \
program and executing a program is unbridgeable. Term-rewriting systems build \
the bridge.\
\>", "Text",
 CellChangeTimes->{{3.543500103962249*^9, 3.543500275707422*^9}, {
  3.543500388520702*^9, 3.543500498901739*^9}, {3.5435005468783016`*^9, 
  ...
  3.553637235149007*^9, 3.5536374334071712`*^9}}]
}, Open  ]],
...
expressions. With term-rewriting in particular, ",
 StyleBox["calculating an answer",
  FontSlant->"Italic"],
 " means ",
 StyleBox["rewriting terms in expressions",
  FontSlant->"Italic"],
 ". This separates expressions that represent computations from the objects \
that carry data. That's the same desideratum that gives rise to constructs \
like the \"with\" statement of JavaScript. However, the ambiguity introduced \
via \"with\" outweighs the advantage of separation of concerns in that case. "
}], "Text",
...
treat data as rewrite rules. This inversion allows developers to manipulate \
...
\>", "Text",
 CellChangeTimes->{{3.5434898488243847`*^9, 3.5434899672155275`*^9}, {
   ...
   3.5435783904927645`*^9}, {3.553637679853662*^9, 3.553637682705997*^9}}],
...
measure, but also to rearrange expressions for optimality, affinity, \
simplicity, or other concerns. Our sample application includes information in \
grams, milligrams, ounces, calories, and percentages. It is too easy to make \
a mistake like adding ounces to grams, or multiplying by percentages instead \
of by fractions. With ordinary JavaScript, the developer can only track units \
of measure mentally while writing the code or externally on paper or in \
comments. A sophisticated JavaScript programmer might record units of measure \
in strings and use string matching to detect errors. This is half way to \
symbolic computing, but includes no ability to do arithmetic.\
\>", "Text",
 CellChangeTimes->{{3.5434898488243847`*^9, 3.5434899672155275`*^9}, {
  3.543490222051527*^9, 3.543490309919527*^9}, {3.5434903503475275`*^9, 
...
Notebook[{
Cell[CellGroupData[{
Cell[1257, 32, 199, 2, 90, "Title"],
Cell[1459, 36, 155, 4, 90, "Title"],
Cell[1617, 42, 183, 5, 54, "Subtitle"],
Cell[CellGroupData[{
Cell[1825, 51, 212, 3, 108, "Section"],
Cell[2040, 56, 2486, 60, 107, "Text"],
Cell[4529, 118, 1342, 31, 84, "Text"],
Cell[5874, 151, 1517, 30, 84, "Text"],
Cell[7394, 183, 1040, 19, 84, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[8471, 207, 144, 2, 108, "Section"],
Cell[8618, 211, 1172, 22, 62, "Text"],
Cell[9793, 235, 589, 9, 39, "Text"],
Cell[CellGroupData[{
Cell[10407, 248, 351, 6, 39, "Item"],
Cell[10761, 256, 270, 5, 39, "Item"]
}, Open  ]],
Cell[11046, 264, 538, 8, 39, "Text"],
Cell[11587, 274, 17179, 287, 629, "Text"],
Cell[28769, 563, 466, 8, 62, "Text"],
Cell[29238, 573, 721, 17, 289, "Program"],
Cell[29962, 592, 1555, 32, 129, "Text"],
Cell[31520, 626, 882, 13, 84, "Text"],
Cell[32405, 641, 478, 12, 192, "Program"],
Cell[32886, 655, 377, 7, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[33300, 667, 118, 1, 108, "Section"],
Cell[33421, 670, 290, 5, 62, "Text"],
Cell[CellGroupData[{
Cell[33736, 679, 119, 1, 51, "Subsection"],
Cell[33858, 682, 839, 18, 39, "Text"],
Cell[34700, 702, 665, 11, 62, "Text"],
Cell[35368, 715, 444, 9, 114, "Program"],
Cell[35815, 726, 458, 10, 39, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[36310, 741, 358, 5, 51, "Subsection"],
Cell[36671, 748, 402, 7, 62, "Text"],
Cell[37076, 757, 379, 7, 75, "Program"],
Cell[37458, 766, 96, 1, 39, "Text"],
Cell[37557, 769, 328, 6, 75, "Program"],
Cell[37888, 777, 271, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[38184, 786, 220, 3, 36, "Subsubsection"],
Cell[38407, 791, 338, 6, 39, "Text"],
Cell[38748, 799, 967, 26, 465, "Program"],
Cell[39718, 827, 182, 2, 39, "Text"],
Cell[39903, 831, 1068, 16, 107, "Text"]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[41020, 853, 129, 1, 51, "Subsection"],
Cell[41152, 856, 290, 6, 39, "Text"],
Cell[41445, 864, 286, 7, 114, "Program"],
Cell[41734, 873, 240, 4, 39, "Text"],
Cell[41977, 879, 301, 9, 172, "Program"],
Cell[42281, 890, 109, 1, 39, "Text"],
Cell[42393, 893, 934, 19, 84, "Text"],
Cell[43330, 914, 559, 10, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[43926, 929, 209, 2, 49, "Subsection"],
Cell[44138, 933, 645, 14, 39, "Text"]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[44832, 953, 166, 2, 108, "Section"],
Cell[45001, 957, 1033, 17, 84, "Text"],
Cell[46037, 976, 590, 9, 62, "Text"],
Cell[46630, 987, 910, 17, 84, "Text"],
Cell[CellGroupData[{
Cell[47565, 1008, 131, 1, 51, "Subsection"],
Cell[47699, 1011, 625, 10, 62, "Text"],
Cell[48327, 1023, 399, 7, 39, "Text"],
Cell[48729, 1032, 2205, 41, 174, "Text"],
Cell[50937, 1075, 834, 15, 62, "Text"],
Cell[51774, 1092, 986, 14, 62, "Text"],
Cell[52763, 1108, 548, 9, 62, "Text"],
Cell[53314, 1119, 230, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[53569, 1128, 1537, 32, 309, "Input"],
Cell[55109, 1162, 33367, 950, 465, "Output"]
}, Open  ]],
Cell[88491, 2115, 846, 15, 84, "Text"],
Cell[CellGroupData[{
Cell[89362, 2134, 180, 3, 55, "Input"],
Cell[89545, 2139, 368, 6, 55, "Output"]
}, Open  ]],
Cell[89928, 2148, 193, 4, 39, "Text"],
Cell[CellGroupData[{
Cell[90146, 2156, 264, 6, 55, "Input"],
Cell[90413, 2164, 307, 5, 55, "Output"]
}, Open  ]],
Cell[90735, 2172, 1100, 21, 84, "Text"],
Cell[CellGroupData[{
Cell[91860, 2197, 141, 2, 19, "Subitem"],
Cell[92004, 2201, 884, 17, 52, "SubitemParagraph"],
Cell[92891, 2220, 96, 1, 19, "Subitem"]
}, Open  ]],
Cell[93002, 2224, 377, 7, 39, "Text"],
Cell[CellGroupData[{
Cell[93404, 2235, 226, 5, 55, "Input"],
Cell[93633, 2242, 308, 5, 55, "Output"]
}, Open  ]],
Cell[93956, 2250, 775, 15, 84, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[94768, 2270, 134, 1, 51, "Subsection"],
Cell[94905, 2273, 121, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[95051, 2278, 112, 2, 55, "Input"],
Cell[95166, 2282, 368, 6, 55, "Output"]
}, Open  ]],
Cell[95549, 2291, 249, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[95823, 2300, 158, 4, 55, "Input"],
Cell[95984, 2306, 310, 5, 55, "Output"]
}, Open  ]],
Cell[96309, 2314, 482, 10, 62, "Text"],
Cell[96794, 2326, 17379, 289, 632, "Text"],
Cell[CellGroupData[{
Cell[114198, 2619, 1437, 30, 309, "Input"],
Cell[115638, 2651, 33330, 949, 465, "Output"]
}, Open  ]],
Cell[148983, 3603, 129, 3, 39, "Text"],
Cell[CellGroupData[{
Cell[149137, 3610, 224, 5, 55, "Input"],
Cell[149364, 3617, 315, 5, 55, "Output"]
}, Open  ]],
Cell[149694, 3625, 968, 16, 107, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[150699, 3646, 110, 1, 51, "Subsection"],
Cell[150812, 3649, 202, 4, 39, "Text"],
Cell[CellGroupData[{
Cell[151039, 3657, 214, 5, 55, "Input"],
Cell[151256, 3664, 372, 6, 55, "Output"]
}, Open  ]],
Cell[151643, 3673, 532, 11, 62, "Text"],
Cell[CellGroupData[{
Cell[152200, 3688, 150, 2, 55, "Input"],
Cell[152353, 3692, 381, 6, 55, "Output"]
}, Open  ]],
Cell[152749, 3701, 215, 3, 39, "Text"],
Cell[CellGroupData[{
Cell[152989, 3708, 198, 4, 55, "Input"],
Cell[153190, 3714, 380, 7, 55, "Output"]
}, Open  ]],
Cell[153585, 3724, 876, 15, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[154498, 3744, 127, 3, 51, "Subsection"],
Cell[154628, 3749, 714, 11, 84, "Text"],
Cell[155345, 3762, 1105, 16, 107, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[156487, 3783, 183, 4, 51, "Subsection"],
Cell[156673, 3789, 251, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[156949, 3798, 302, 7, 102, "Input"],
Cell[157254, 3807, 395, 8, 55, "Output"]
}, Open  ]],
Cell[157664, 3818, 162, 3, 39, "Text"],
Cell[CellGroupData[{
Cell[157851, 3825, 340, 7, 102, "Input"],
Cell[158194, 3834, 319, 5, 55, "Output"]
}, Open  ]],
Cell[158528, 3842, 126, 3, 39, "Text"],
Cell[158657, 3847, 913, 17, 84, "Text"],
Cell[159573, 3866, 1035, 25, 84, "Text"],
Cell[CellGroupData[{
Cell[160633, 3895, 318, 6, 102, "Input"],
Cell[160954, 3903, 367, 6, 55, "Output"]
}, Open  ]],
Cell[161336, 3912, 399, 11, 39, "Text"],
Cell[CellGroupData[{
Cell[161760, 3927, 341, 7, 102, "Input"],
Cell[162104, 3936, 343, 5, 55, "Output"]
}, Open  ]]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[162508, 3948, 202, 3, 108, "Section"],
Cell[162713, 3953, 384, 6, 62, "Text"],
Cell[163100, 3961, 595, 9, 62, "Text"],
Cell[163698, 3972, 40995, 677, 411, "Text"],
Cell[204696, 4651, 194, 6, 39, "Text"],
Cell[CellGroupData[{
Cell[204915, 4661, 435, 10, 125, "Input"],
Cell[205353, 4673, 446, 9, 55, "Output"]
}, Open  ]],
Cell[205814, 4685, 112, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[205951, 4690, 478, 9, 125, "Input"],
Cell[206432, 4701, 404, 6, 55, "Output"]
}, Open  ]],
Cell[206851, 4710, 858, 13, 107, "Text"],
Cell[207712, 4725, 539, 11, 66, "Text"],
Cell[208254, 4738, 644, 10, 62, "Text"],
Cell[208901, 4750, 195, 2, 39, "Text"],
Cell[209099, 4754, 99098, 1630, 1066, "Text"],
Cell[308200, 6386, 658, 10, 84, "Text"],
Cell[308861, 6398, 644, 12, 62, "Text"],
Cell[CellGroupData[{
Cell[309530, 6414, 520, 13, 125, "Input"],
Cell[310053, 6429, 366, 6, 55, "Output"]
}, Open  ]],
Cell[310434, 6438, 317, 6, 39, "Text"],
Cell[310754, 6446, 604, 14, 39, "Text"],
Cell[311361, 6462, 1006, 31, 102, "Input"],
Cell[312370, 6495, 102, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[312497, 6500, 524, 14, 102, "Input"],
Cell[313024, 6516, 397, 6, 55, "Output"]
}, Open  ]],
Cell[313436, 6525, 585, 13, 62, "Text"],
Cell[314024, 6540, 541, 10, 39, "Text"],
Cell[314568, 6552, 410, 7, 62, "Text"],
Cell[314981, 6561, 535, 10, 62, "Text"],
Cell[CellGroupData[{
Cell[315541, 6575, 665, 16, 125, "Input"],
Cell[316209, 6593, 410, 7, 55, "Output"]
}, Open  ]],
Cell[316634, 6603, 276, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[316935, 6612, 296, 4, 55, "Input"],
Cell[317234, 6618, 622, 13, 79, "Output"]
}, Open  ]],
Cell[317871, 6634, 238, 5, 39, "Text"],
Cell[318112, 6641, 580, 15, 125, "Input"],
Cell[CellGroupData[{
Cell[318717, 6660, 403, 8, 55, "Input"],
Cell[319123, 6670, 436, 6, 55, "Output"]
}, Open  ]],
Cell[319574, 6679, 306, 6, 39, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[319917, 6690, 112, 1, 108, "Section"],
Cell[320032, 6693, 271, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[320328, 6702, 1608, 31, 309, "Input"],
Cell[321939, 6735, 33478, 950, 465, "Output"]
}, Open  ]],
Cell[355432, 7688, 119, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[355576, 7693, 316, 7, 55, "Input"],
Cell[355895, 7702, 332, 5, 55, "Output"]
}, Open  ]],
Cell[356242, 7710, 400, 9, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[356679, 7724, 108, 1, 108, "Section"],
Cell[356790, 7727, 311, 6, 39, "Text"],
Cell[CellGroupData[{
Cell[357126, 7737, 103, 1, 51, "Subsection"],
Cell[357232, 7740, 754, 11, 107, "Text"],
Cell[357989, 7753, 759, 17, 289, "Program"]
}, Open  ]],
Cell[CellGroupData[{
Cell[358785, 7775, 99, 1, 51, "Subsection"],
Cell[358887, 7778, 677, 12, 62, "Text"],
Cell[359567, 7792, 342, 6, 55, "Program"],
Cell[359912, 7800, 155, 3, 39, "Text"],
Cell[360070, 7805, 501, 8, 55, "Program"],
Cell[360574, 7815, 132, 1, 39, "Text"],
Cell[360709, 7818, 448, 8, 94, "Program"],
Cell[361160, 7828, 129, 1, 39, "Text"],
Cell[361292, 7831, 102, 1, 55, "Program"],
Cell[361397, 7834, 120, 1, 39, "Text"],
Cell[361520, 7837, 350, 7, 94, "Program"],
Cell[361873, 7846, 102, 1, 39, "Text"],
Cell[361978, 7849, 568, 11, 133, "Program"],
Cell[362549, 7862, 95, 1, 39, "Text"],
Cell[362647, 7865, 108, 1, 55, "Program"],
Cell[362758, 7868, 487, 9, 39, "Text"],
Cell[363248, 7879, 1090, 21, 289, "Program"],
Cell[364341, 7902, 108, 1, 39, "Text"],
Cell[364452, 7905, 293, 5, 55, "Program"],
Cell[364748, 7912, 93, 1, 39, "Text"],
Cell[364844, 7915, 245, 3, 55, "Program"],
Cell[365092, 7920, 166, 2, 39, "Text"],
Cell[365261, 7924, 373, 8, 114, "Program"],
Cell[365637, 7934, 95, 1, 39, "Text"],
Cell[365735, 7937, 114, 1, 55, "Program"]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[365898, 7944, 94, 1, 108, "Section"],
Cell[CellGroupData[{
Cell[366017, 7949, 125, 1, 51, "Subsection"],
Cell[366145, 7952, 1012, 15, 84, "Text"],
Cell[367160, 7969, 1182, 17, 107, "Text"],
Cell[368345, 7988, 1232, 22, 107, "Text"],
Cell[369580, 8012, 1570, 29, 107, "Text"],
Cell[371153, 8043, 1066, 16, 107, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[372256, 8064, 150, 2, 51, "Subsection"],
Cell[372409, 8068, 1571, 26, 84, "Text"],
Cell[373983, 8096, 1093, 16, 62, "Text"],
Cell[375079, 8114, 1030, 15, 84, "Text"],
Cell[376112, 8131, 1298, 18, 129, "Text"],
Cell[377413, 8151, 599, 9, 62, "Text"],
Cell[378015, 8162, 174, 4, 28, "Input",
 CellOpen->False,
 InitializationCell->True]
}, Open  ]]
}, Open  ]]
...
(* NotebookSignature JwDTvSyxPknGmAKF5t3jFoo8 *)
