...
NotebookDataLength[    731352,      18142]
NotebookOptionsPosition[    712801,      17578]
NotebookOutlinePosition[    716392,      17701]
CellTagsIndexPosition[    715628,      17673]
WindowFrame->Normal*)
...
vector space with basis vectors comprising the Nutrition Facts Labels of the \
...
JavaScript programmers might not use it in their own code every day, they use \
it every time they edit, compile, interpret, or debug their code. \
Historically, symbolic computing has been a mission-critical, if invisible, \
part of real-world, multi-billion-dollar operating system kernels for tasks \
such as ",
...
methodology, routinely applied \"under the radar\" for many decades but \
...
Cell["Robust Unit Conversions Close the Gap", "Subsection",
...
agenda: using mined NFLs to generated new NFLs from recipes. We assume that \
either we\[CloseCurlyQuote]re going to correct the mined NFLs or that we\
\[CloseCurlyQuote]re just going to accept them as the best we can do for now. \
In any event, the following is a much more adventurous use of symbolic \
computing, involving rules that write rules that rewrite expressions, \
canonicalization, normalization (in the vector-space sense), and monadic \
operators like ",
...
Cell["\<\
and then convert all such weights to Grams by mapping a function over teh \
result above:\
\>", "Text",
...
Cell[TextData[{
 "The next step is to make a rule to canonicalize the units in an NFL. The \
following takes an NFL and maps a function over a transform of the NFL. The \
NFL is a list of rules, and the transform will also be a list of rules. The \
transform will do a ",
...
transformed rule lines will map the given weights into Grams. We have \
emphasized the rule arrows to emphasize the fact that there are three uses of \
rule here: one for the input rule, ",
 Cell[BoxData[
...
output rule, written ",
 ...
 " -- that\[CloseCurlyQuote]s the meaning of the strange colon-arrow. It \
tells the evaluator to delay evaluation of the right-hand side until \
rule-application time so that the density lookup will not be done too early. \
The normal evaluation time for the right-hand sides of Rules is at \
rule-definition time, and that is often fine. In this case, however, it would \
cause the density lookup to be done on an input of ",
...
Cell["\<\
Symbolic computing is a general style of computing. Any program that \
manipulates symbols as opposed to just manipulating numbers is a symbolic \
program. Symbolic programs are not exotic: you use them every day. Parsers, \
interpreters, compilers, regular-expression libraries; stream-editing \
programs like Perl, Sed, and Awk, macro processors like m4 and t4; templating \
programs, schema validators, all do symbolic computing. Even arcane uses of \
symbolic computing such as reasoning over knowledge is completely mundane, \
being embedded in operating-system kernels and network-security layers.\
\>", "Text",
...
CellTagsIndex->{
 "00002765"->{
  Cell[704346, 16918, 290, 19, 34, "Reference",
   CellTags->"00002765"]},
 "0000381F"->{
  Cell[704639, 16939, 328, 21, 34, "Reference",
   CellTags->"0000381F"]},
 "00003589"->{
  Cell[704970, 16962, 326, 24, 34, "Reference",
   CellTags->"00003589"]},
 "000047E5"->{
  Cell[705299, 16988, 369, 28, 34, "Reference",
   CellTags->"000047E5"]},
 "00001EB5"->{
  Cell[705671, 17018, 271, 17, 34, "Reference",
   CellTags->"00001EB5"]},
 "00009BEE"->{
  Cell[705945, 17037, 576, 53, 34, "Reference",
   CellTags->"00009BEE"]},
 "00001EF6"->{
  Cell[706524, 17092, 272, 17, 34, "Reference",
   CellTags->"00001EF6"]},
 "00004D0E"->{
  Cell[706799, 17111, 414, 32, 34, "Reference",
   CellTags->"00004D0E"]},
 "000033FD"->{
  Cell[707216, 17145, 327, 23, 34, "Reference",
   CellTags->"000033FD"]},
 "00002E07"->{
  Cell[707546, 17170, 302, 20, 34, "Reference",
"Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[112497, 2633, 134, 1, 51, "Subsection"],
Cell[112634, 2636, 121, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[112780, 2641, 112, 2, 55, "Input"],
Cell[112895, 2645, 460, 7, 55, "Output"]
}, Open  ]],
Cell[113370, 2655, 249, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[113644, 2664, 158, 4, 55, "Input"],
Cell[113805, 2670, 402, 6, 55, "Output"]
}, Open  ]],
Cell[114222, 2679, 482, 10, 62, "Text"],
Cell[114707, 2691, 17379, 289, 632, "Text"],
Cell[CellGroupData[{
Cell[132111, 2984, 1437, 30, 309, "Input"],
Cell[133551, 3016, 33423, 950, 465, "Output"]
}, Open  ]],
Cell[166989, 3969, 121, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[167135, 3974, 224, 5, 55, "Input"],
Cell[167362, 3981, 407, 6, 55, "Output"]
}, Open  ]],
Cell[167784, 3990, 2603, 54, 141, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[170424, 4049, 110, 1, 51, "Subsection"],
Cell[170537, 4052, 202, 4, 39, "Text"],
Cell[CellGroupData[{
Cell[170764, 4060, 214, 5, 55, "Input"],
Cell[170981, 4067, 463, 7, 55, "Output"]
}, Open  ]],
Cell[171459, 4077, 587, 11, 62, "Text"],
Cell[CellGroupData[{
Cell[172071, 4092, 150, 2, 55, "Input"],
Cell[172224, 4096, 473, 7, 55, "Output"]
}, Open  ]],
Cell[172712, 4106, 215, 3, 39, "Text"],
Cell[CellGroupData[{
Cell[172952, 4113, 198, 4, 55, "Input"],
Cell[173153, 4119, 475, 8, 55, "Output"]
}, Open  ]],
Cell[173643, 4130, 882, 14, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[174562, 4149, 119, 1, 51, "Subsection"],
Cell[174684, 4152, 752, 11, 84, "Text"],
Cell[175439, 4165, 1054, 17, 107, "Text"],
Cell[176496, 4184, 657, 10, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[177190, 4199, 175, 2, 51, "Subsection"],
Cell[177368, 4203, 303, 6, 39, "Text"],
Cell[CellGroupData[{
Cell[177696, 4213, 302, 7, 102, "Input"],
Cell[178001, 4222, 488, 9, 55, "Output"]
}, Open  ]],
Cell[178504, 4234, 162, 3, 39, "Text"],
Cell[CellGroupData[{
Cell[178691, 4241, 340, 7, 102, "Input"],
Cell[179034, 4250, 411, 6, 55, "Output"]
}, Open  ]],
Cell[179460, 4259, 118, 1, 39, "Text"],
Cell[179581, 4262, 954, 18, 84, "Text"],
Cell[180538, 4282, 1063, 22, 84, "Text"],
Cell[CellGroupData[{
Cell[181626, 4308, 318, 6, 102, "Input"],
Cell[181947, 4316, 465, 8, 55, "Output"]
}, Open  ]],
Cell[182427, 4327, 399, 11, 39, "Text"],
Cell[CellGroupData[{
Cell[182851, 4342, 341, 7, 102, "Input"],
Cell[183195, 4351, 439, 7, 55, "Output"]
}, Open  ]]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[183695, 4365, 202, 3, 108, "Section"],
Cell[183900, 4370, 437, 7, 62, "Text"],
Cell[184340, 4379, 645, 10, 62, "Text"],
Cell[184988, 4391, 40995, 677, 411, "Text"],
Cell[225986, 5070, 194, 6, 39, "Text"],
Cell[CellGroupData[{
Cell[226205, 5080, 435, 10, 125, "Input"],
Cell[226643, 5092, 541, 10, 55, "Output"]
}, Open  ]],
Cell[227199, 5105, 112, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[227336, 5110, 478, 9, 125, "Input"],
Cell[227817, 5121, 494, 7, 55, "Output"]
}, Open  ]],
Cell[228326, 5131, 561, 9, 62, "Text"],
Cell[228890, 5142, 888, 14, 107, "Text"],
Cell[229781, 5158, 644, 10, 62, "Text"],
Cell[230428, 5170, 195, 2, 39, "Text"],
Cell[230626, 5174, 99098, 1630, 1066, "Text"],
Cell[329727, 6806, 702, 11, 84, "Text"],
Cell[330432, 6819, 691, 13, 62, "Text"],
Cell[CellGroupData[{
Cell[331148, 6836, 520, 13, 125, "Input"],
Cell[331671, 6851, 458, 7, 55, "Output"]
}, Open  ]],
Cell[332144, 6861, 413, 9, 39, "Text"],
Cell[332560, 6872, 1477, 33, 74, "Text"],
Cell[334040, 6907, 1006, 31, 102, "Input"],
Cell[335049, 6940, 102, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[335176, 6945, 524, 14, 102, "Input"],
Cell[335703, 6961, 491, 7, 55, "Output"]
}, Open  ]],
Cell[336209, 6971, 622, 14, 62, "Text"],
Cell[336834, 6987, 600, 11, 62, "Text"],
Cell[337437, 7000, 457, 8, 62, "Text"],
Cell[337897, 7010, 623, 13, 62, "Text"],
Cell[CellGroupData[{
Cell[338545, 7027, 665, 16, 125, "Input"],
Cell[339213, 7045, 506, 9, 55, "Output"]
}, Open  ]],
Cell[339734, 7057, 276, 5, 39, "Text"],
Cell[CellGroupData[{
Cell[340035, 7066, 296, 4, 55, "Input"],
Cell[340334, 7072, 735, 15, 79, "Output"]
}, Open  ]],
Cell[341084, 7090, 238, 5, 39, "Text"],
Cell[341325, 7097, 580, 15, 125, "Input"],
Cell[CellGroupData[{
Cell[341930, 7116, 403, 8, 55, "Input"],
Cell[342336, 7126, 534, 8, 55, "Output"]
}, Open  ]],
Cell[342885, 7137, 310, 6, 39, "Text"],
Cell[343198, 7145, 289, 5, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[343524, 7155, 151, 2, 108, "Section"],
Cell[343678, 7159, 320, 6, 39, "Text"],
Cell[CellGroupData[{
Cell[344023, 7169, 1608, 31, 309, "Input"],
Cell[345634, 7202, 33576, 952, 465, "Output"]
}, Open  ]],
Cell[379225, 8157, 119, 1, 39, "Text"],
Cell[CellGroupData[{
Cell[379369, 8162, 316, 7, 55, "Input"],
Cell[379688, 8171, 428, 7, 55, "Output"]
}, Open  ]],
Cell[380131, 8181, 400, 9, 62, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[380568, 8195, 108, 1, 108, "Section"],
Cell[380679, 8198, 311, 6, 39, "Text"],
Cell[CellGroupData[{
Cell[381015, 8208, 103, 1, 51, "Subsection"],
Cell[381121, 8211, 754, 11, 107, "Text"],
Cell[381878, 8224, 759, 17, 289, "Program"]
}, Open  ]],
Cell[CellGroupData[{
Cell[382674, 8246, 99, 1, 51, "Subsection"],
Cell[382776, 8249, 742, 14, 84, "Text"],
Cell[383521, 8265, 342, 6, 55, "Program"],
Cell[383866, 8273, 155, 3, 39, "Text"],
Cell[384024, 8278, 501, 8, 55, "Program"],
Cell[384528, 8288, 132, 1, 39, "Text"],
Cell[384663, 8291, 448, 8, 94, "Program"],
Cell[385114, 8301, 129, 1, 39, "Text"],
Cell[385246, 8304, 102, 1, 55, "Program"],
Cell[385351, 8307, 120, 1, 39, "Text"],
Cell[385474, 8310, 350, 7, 94, "Program"],
Cell[385827, 8319, 102, 1, 39, "Text"],
Cell[385932, 8322, 568, 11, 133, "Program"],
Cell[386503, 8335, 95, 1, 39, "Text"],
Cell[386601, 8338, 108, 1, 55, "Program"],
Cell[386712, 8341, 487, 9, 39, "Text"],
Cell[387202, 8352, 1090, 21, 289, "Program"],
Cell[388295, 8375, 108, 1, 39, "Text"],
Cell[388406, 8378, 293, 5, 55, "Program"],
Cell[388702, 8385, 93, 1, 39, "Text"],
Cell[388798, 8388, 245, 3, 55, "Program"],
Cell[389046, 8393, 166, 2, 39, "Text"],
Cell[389215, 8397, 373, 8, 114, "Program"],
Cell[389591, 8407, 95, 1, 39, "Text"],
Cell[389689, 8410, 114, 1, 55, "Program"]
}, Open  ]]
}, Open  ]],
Cell[CellGroupData[{
Cell[389852, 8417, 127, 1, 108, "Section"],
Cell[389982, 8420, 867, 16, 129, "Text"],
Cell[390852, 8438, 324, 6, 39, "Text"],
Cell[391179, 8446, 1772, 34, 347, "Code",
 InitializationCell->False],
Cell[392954, 8482, 711, 11, 107, "Text"],
Cell[393668, 8495, 231, 4, 39, "Text"],
Cell[393902, 8501, 2086, 49, 186, "Code",
 InitializationCell->False],
Cell[395991, 8552, 638, 10, 84, "Text"],
Cell[396632, 8564, 2305, 58, 197, "Text"],
Cell[398940, 8624, 1627, 29, 127, "Input"],
Cell[400570, 8655, 2756, 66, 141, "Text"],
Cell[403329, 8723, 1664, 35, 186, "Input"],
Cell[404996, 8760, 211, 4, 39, "Text"],
Cell[CellGroupData[{
Cell[405232, 8768, 499, 10, 55, "Input"],
Cell[405734, 8780, 37384, 1020, 305, "Output"]
}, Open  ]],
Cell[443133, 9803, 294, 5, 62, "Text"],
Cell[443430, 9810, 412, 8, 62, "Text"],
Cell[443845, 9820, 641, 16, 79, "Input"],
Cell[444489, 9838, 1192, 31, 186, "Input"],
Cell[CellGroupData[{
Cell[445706, 9873, 536, 10, 55, "Input"],
Cell[446245, 9885, 9262, 251, 141, "Output"]
}, Open  ]],
Cell[455522, 10139, 311, 5, 62, "Text"],
Cell[CellGroupData[{
Cell[455858, 10148, 236, 6, 55, "Input"],
Cell[456097, 10156, 25720, 785, 371, "Output"]
}, Open  ]],
Cell[481832, 10944, 180, 4, 39, "Text"],
Cell[CellGroupData[{
Cell[482037, 10952, 674, 16, 148, "Input"],
Cell[482714, 10970, 26001, 789, 371, "Output"]
}, Open  ]],
Cell[508730, 11762, 370, 6, 62, "Text"],
Cell[CellGroupData[{
Cell[509125, 11772, 505, 13, 57, "Input"],
Cell[509633, 11787, 1224, 18, 55, "Output"]
}, Open  ]],
Cell[510872, 11808, 207, 4, 39, "Text"],
Cell[511082, 11814, 869, 13, 107, "Text"],
Cell[511954, 11829, 3437, 71, 702, "Code",
 InitializationCell->False],
Cell[515394, 11902, 194, 4, 39, "Text"],
Cell[CellGroupData[{
Cell[515613, 11910, 1392, 30, 125, "Input"],
Cell[517008, 11942, 52217, 1521, 819, "Output"]
}, Open  ]],
Cell[569240, 13466, 192, 4, 39, "Text"],
Cell[569435, 13472, 1960, 39, 148, "Input"],
Cell[571398, 13513, 2034, 40, 148, "Input"],
Cell[573435, 13555, 1794, 37, 148, "Input"],
Cell[575232, 13594, 1879, 39, 148, "Input"],
Cell[577114, 13635, 1844, 38, 148, "Input"],
Cell[578961, 13675, 1569, 34, 148, "Input"],
Cell[580533, 13711, 1677, 36, 148, "Input"],
Cell[582213, 13749, 1596, 34, 171, "Input"],
Cell[583812, 13785, 1605, 34, 194, "Input"],
Cell[585420, 13821, 1772, 35, 217, "Input"],
Cell[587195, 13858, 1764, 36, 194, "Input"],
Cell[588962, 13896, 273, 5, 39, "Text"],
Cell[589238, 13903, 1231, 28, 171, "Input"],
Cell[590472, 13933, 334, 6, 62, "Text"],
Cell[590809, 13941, 3147, 66, 242, "Text"],
Cell[593959, 14009, 3342, 70, 377, "Input"],
Cell[597304, 14081, 652, 10, 84, "Text"],
Cell[597959, 14093, 900, 19, 55, "Input"],
Cell[598862, 14114, 608, 16, 84, "Text"],
Cell[CellGroupData[{
Cell[599495, 14134, 487, 11, 55, "Input"],
Cell[599985, 14147, 1331, 20, 55, "Output"]
}, Open  ]],
Cell[601331, 14170, 307, 7, 39, "Text"],
Cell[601641, 14179, 1125, 27, 126, "Input"],
Cell[602769, 14208, 398, 11, 62, "Text"],
Cell[603170, 14221, 696, 13, 55, "Input"],
Cell[603869, 14236, 246, 4, 39, "Text"],
Cell[604118, 14242, 406, 11, 55, "Input"],
Cell[604527, 14255, 336, 6, 62, "Text"],
Cell[604866, 14263, 1323, 31, 126, "Input"],
Cell[606192, 14296, 363, 7, 62, "Text"],
Cell[606558, 14305, 574, 11, 55, "Input"],
Cell[607135, 14318, 337, 6, 39, "Text"],
Cell[607475, 14326, 1849, 45, 149, "Input"],
Cell[609327, 14373, 1600, 44, 74, "Text"],
Cell[CellGroupData[{
Cell[610952, 14421, 609, 14, 55, "Input"],
Cell[611564, 14437, 78565, 2199, 987, "Output"]
}, Open  ]],
Cell[690144, 16639, 230, 5, 39, "Text"]
}, Open  ]],
Cell[690389, 16647, 127, 3, 108, "Section"],
Cell[CellGroupData[{
Cell[690541, 16654, 94, 1, 61, "Section"],
Cell[CellGroupData[{
Cell[690660, 16659, 125, 1, 51, "Subsection"],
Cell[690788, 16662, 1218, 17, 107, "Text"],
Cell[692009, 16681, 1218, 18, 107, "Text"],
Cell[693230, 16701, 1232, 22, 107, "Text"],
Cell[694465, 16725, 2787, 59, 131, "Text"],
Cell[697255, 16786, 1245, 22, 107, "Text"]
}, Open  ]],
Cell[CellGroupData[{
Cell[698537, 16813, 150, 2, 51, "Subsection"],
Cell[698690, 16817, 2088, 34, 129, "Text"],
Cell[700781, 16853, 1030, 15, 84, "Text"],
Cell[701814, 16870, 1393, 20, 129, "Text"],
Cell[703210, 16892, 599, 9, 62, "Text"],
Cell[703812, 16903, 243, 4, 39, "Text"],
Cell[704058, 16909, 285, 7, 28, "Input",
 CellOpen->False,
 InitializationCell->True],
Cell[704346, 16918, 290, 19, 34, "Reference",
 CellTags->"00002765"],
...
(* NotebookSignature bvTs1gRROjOVYBKCBRBeUMKn *)
